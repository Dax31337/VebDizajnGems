<?php include('web/header.php');?>
	<div class="container" style="padding: 0px;">
		<img src="img-png/index.png" alt="index" style="display: flex; max-width: 100%; height: auto;">
	</div>
	<div>
	...
	<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
  		<div class="carousel-inner">
    		<div class="carousel-item active">
				<img src="img/oniks-index.png" alt="Oniks" class="d-block w-100">
    		...
    		<div class="carousel-item">
				<img src="img/djejd-index.png" alt="Djejd" class="d-block w-100">
				<div class="carousel-caption">
    		...
    		<div class="carousel-item">
				<img src="img/svelerajt-index.png" alt="Svelerajt" class="d-block w-100">
				<div class="carousel-caption">
...
<div class="container" style="width: 100%; border: 2px solid; border-color: #6DAA79; border-radius: 8px; padding: 15px;">
	<div class="row">
		<div class="col" style="border: 2px solid; border-color: #6DAA79; border-radius: 8px; padding: 15px;">
			<div class="col">
				<h2 class="generic"> Sjajni poklon za Vase najbolje </h2>
			</div>
			<div class="col">
				<p class="generic"> Prstenovi, mindjuse, narukvice, ogrlice, i mnogo vise - pronadjite njihov omiljeni dragi kamen kod nas. </p>
			</div>
		</div>			
		<div class="col">
...
<div class="container" style="width: 100%; border: 2px solid; border-color: #6DAA79; border-radius: 8px; padding: 15px;">
	<div class="row">
		<div class="col" style="border: 2px solid; border-color: #6DAA79; border-radius: 8px; padding: 15px;">
			<div class="col">
				<h2 class="generic"> Egzoticno, industrijsko, kao pravo! </h2>
			</div>
			<div class="col">
				<p class="generic"> Nudivo Vam ponude na razlicite vrste zlatnih legura, kao sto je rozen zlato, tumbaga, ljubicasto zlato, i vise. I ne samo to - vec i industrijske dijamante i slicne karbon-bazirane dragulje. </p>
			</div>
		</div>
		<div class="col">
...
<div class="container" style="width: 100%; border: 2px solid; border-color: #6DAA79; border-radius: 8px; padding: 15px;">
	<div class="row">
		<div class="col" style="border: 2px solid; border-color: #6DAA79; border-radius: 8px; padding: 15px;">
			<div class="col">
				<h2 class="generic"> Gde najblize za rukovanje? </h2>
			</div>
			<div class="col">
				<p class="generic"> Nase glavno sediste sa nalazi ovde - posetite nas! </p>
			</div>
		</div>
		<div class="col">
